...
if __name__ == '__main__':
    ...
    parser.add_argument('--path',type=str,default='D:\\时序数据集\\all_datasets\\all_datasets\\MSL\\MSL_test.npy') # 数据路径
    ...
    parser.add_argument('--checkpoint',type=str,default='D:\\2024TS\\LVM\\evaluation\\LVM_ckpts') # LLaMA模型权重路径
